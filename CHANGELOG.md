...
Features
    ...
    Press slide button once to enter crouch/slide, press again to exit
    Prevents automatic uncrouching when toggle is active
    Improved accessibility for players preferring toggle controls
